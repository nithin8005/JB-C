...
title: Affiliates
intro: >-
  Acharya ecosystem and ventures aligned with our work — the parent group and member
  institutions, plus direct ventures led by Jay Basani.
groups:
  - title: Parent Group
    items:
      - name: Acharya Group of Institutions
        logo: /logos/acharya-group.png
  ...
  - title: Member Institutions
    items:
      ...
      - name: ĀKAR PUC College
        logo: /logos/akarcollage.png
        logoAlt: ĀKAR PUC College
        href: https://www.acharya.ac.in/puc/
      - name: Acharya University, Uzbekistan
        logo: /logos/acharya-university-uzbekistan.png
        logoAlt: Acharya University Uzbekistan
        href: https://www.acharya.ac.uz/
      - name: Global MBA
        logo: /logos/acharya-global-mba.png
        logoAlt: Acharya Global MBA
        href: https://www.acharya.ac.in/gmba/
  - title: Direct Ventures 
    items:
      - name: Psionics
        logo: /logos/Psionics1.svg
        logoAlt: Psionics
        description: Data center infrastructure and digital capacity for AI and cloud workloads.
        href: https://psionics.co

      - name: MAM Minerals
        logo: /logos/mam-minerals.png
        logoAlt: MAM Minerals
        description: Largest beneficiated iron ore mine, Malaysia.
      
      - name: Tentworks Interactive
        logo: /logos/tentworks1.png
        logoAlt: Tentworks Interactive
        description: Global game development — tycoon and strategy experiences.
